...
[![Build Status](https://travis-ci.com/cisagov/freeipa-tf-module.svg?branch=develop)](https://travis-ci.com/cisagov/freeipa-tf-module)
...
```hcl
module "example" {
  source = "github.com/cisagov/freeipa-tf-module"
...
* [Deploying into the default VPC](https://github.com/cisagov/freeipa-tf-module/tree/develop/examples/default_vpc)
